...
export const catalog: Catalog = {
  ...
  'settings.section.audio': { en: 'Audio Mixer', id: 'Pencampur Audio' },
  'settings.audio.master': { en: 'Master volume', id: 'Volume utama' },
  'settings.audio.chime': { en: 'Chime volume', id: 'Volume bel' },
  'settings.audio.notif': { en: 'Notification volume', id: 'Volume notifikasi' },
  'settings.audio.mute': { en: 'Mute', id: 'Diam' },
  'settings.audio.unmute': { en: 'Unmute', id: 'Aktifkan' },
  'settings.audio.test': { en: 'Test sounds', id: 'Tes suara' },
  'settings.audio.testHint': {
    en: 'Plays one of each: chime + notification',
    id: 'Mainkan satu dari masing-masing: bel + notifikasi',
  },
  ...
  'settings.clockColor.custom': { en: 'Custom color', id: 'Warna kustom' },
  'settings.clockColor.customHex': { en: 'Pick custom color', id: 'Pilih warna kustom' },
  'settings.clockColor.customHexText': { en: 'Custom HEX', id: 'HEX kustom' },
  ...
  'settings.wallpaper.custom': { en: 'Custom image', id: 'Gambar kustom' },
  'settings.wallpaper.customHint': {
    en: 'Drop an image or click to upload — max 5 MB',
    id: 'Letakkan gambar atau klik untuk upload — maks 5 MB',
  },
  'settings.wallpaper.customUrl': { en: 'Or paste an image URL', id: 'Atau tempel URL gambar' },
  'settings.wallpaper.customLoad': { en: 'Load URL', id: 'Muat URL' },
  'settings.wallpaper.customRemove': { en: 'Remove', id: 'Hapus' },
  'settings.wallpaper.customSize': {
    en: '{w}×{h} · {kb} KB',
    id: '{w}×{h} · {kb} KB',
  },
  'settings.wallpaper.position': { en: 'Position', id: 'Posisi' },
  'settings.wallpaper.position.cover': { en: 'Cover', id: 'Penuh' },
  'settings.wallpaper.position.contain': { en: 'Contain', id: 'Pas' },
  'settings.wallpaper.position.center': { en: 'Center', id: 'Tengah' },
  'settings.wallpaper.position.tile': { en: 'Tile', id: 'Ulang' },
  'settings.wallpaper.error': {
    en: 'Could not load image — check the URL or try a smaller file',
    id: 'Tidak bisa memuat gambar — periksa URL atau coba file lebih kecil',
  },
  'settings.wallpaper.dropHere': { en: 'Drop image here', id: 'Letakkan gambar di sini' },
  'settings.ambient.volume': { en: 'Volume', id: 'Volume' },
  'settings.ambient.rain': { en: 'Rain', id: 'Hujan' },
  'settings.ambient.forest': { en: 'Forest', id: 'Hutan' },
  'settings.ambient.white': { en: 'White', id: 'Putih' },
  'settings.ambient.fireplace': { en: 'Fireplace', id: 'Perapian' },
  'settings.ambient.ocean': { en: 'Ocean', id: 'Laut' },
  'settings.ambient.stream': { en: 'Stream', id: 'Sungai' },
  'settings.ambient.wind': { en: 'Wind', id: 'Angin' },
  'settings.ambient.night': { en: 'Night', id: 'Malam' },
  'settings.ambient.cafe': { en: 'Cafe', id: 'Kafe' },
  ...
  'pomodoro.sound': { en: 'sound', id: 'suara' },
  'pomodoro.chime.bell': { en: 'Two-tone bell', id: 'Bel dua nada' },
  'pomodoro.chime.ding': { en: 'Soft ding', id: 'Ding lembut' },
  'pomodoro.chime.gong': { en: 'Deep gong', id: 'Gong dalam' },
  'pomodoro.chime.wood': { en: 'Wood block', id: 'Balok kayu' },
  'pomodoro.chime.digital': { en: 'Digital beep', id: 'Bip digital' },
  'pomodoro.chime.mute': { en: 'Mute', id: 'Diam' },

  // ── affirmation widget ───────────────────────────────────────
  'affirmation.title': { en: 'Daily affirmation', id: 'Afirmasi harian' },
  'affirmation.cat.all': { en: 'all', id: 'semua' },
  'affirmation.cat.motivational': { en: 'motivational', id: 'motivasi' },
  'affirmation.cat.calm': { en: 'calm', id: 'tenang' },
  'affirmation.cat.stoic': { en: 'stoic', id: 'stoik' },
  ...
  'alarm.test.body': { en: 'Notifications work — your alarm will fire even if the tab is in the background.', id: 'Notifikasi berfungsi — alarm tetap menyala walau tab di latar belakang.' },
  'alarm.test.sent': { en: 'Sent — check your OS notification panel', id: 'Terkirim — cek panel notifikasi OS' },
  'alarm.test.denied': { en: 'Permission denied — enable in browser settings', id: 'Izin ditolak — aktifkan di pengaturan browser' },
